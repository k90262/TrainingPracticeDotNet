...
namespace BlueYonder.Flights.GroupProxy
{
    public static class BookFlightFunc
    {
        ...
        {
            // https://ychobillabfunc.azurewebsites.net/api/BookFlightFunc?flightId=1&code=adWRCaaMCdJ2favqaJQHsJdKsDP6rub83ZqQ4bj479zeUVfirudq3A==
            ...
            var flightServiceUrl = $"http://blueyonder-flights-ychobilllab.azurewebsites.net/api/flights/bookFlight?flightId={flightId}";
